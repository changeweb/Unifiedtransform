                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="card text-white bg-primary mb-3">
                                <div class="card-header">@lang('Schools') - <b>{{$school_count}}</b></div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card text-white bg-success mb-3">
                                <div class="card-header">@lang('Admins') - <b>{{$admins_count}}</b></div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card text-white bg-dark mb-3">
                                <div class="card-header">@lang('Teachers') - <b>{{$teachers_count}}</b></div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card text-white bg-danger mb-3">
                                <div class="card-header">@lang('Students') - <b>{{$students_count}}</b></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
