...
Route::middleware(['auth', 'admin'])->group(function () {
  ...
  Route::post('/edit-department/{department}', 'DepartmentController@update')->name('department.update');
  Route::post('/department/delete/{department}', 'DepartmentController@destroy')->name('department.destroy');
