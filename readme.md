...
* [Laravel Page Speed Package](https://github.com/renatomarinho/laravel-page-speed) is used to optimize your site automatically which results in a 35%+ optimization. You may need to run `php artisan vendor:publish --provider="RenatoMarinho\LaravelPageSpeed\ServiceProvider"`.
